...
//		
//		// 제네릭클래스
//		GenericBox<Object> box1 = new GenericBox<Integer>(); // 제네릭에선 상속 관계가 아니어서 생성이 불가
...
//		test4(new GenericBox<SmartPhone>());
	...
	// GenericBox객체의 타입파라미터가 Numebr이거나 Number의 하위타입인 것만 전달받을 수 있다.
