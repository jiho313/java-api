...
public class BankingRepository {
	// 단위 작업
	// 메소드를 만들 때는 매개변수와 반환타입을 신경쓴다.
	/*
	 * Map<Integer, Account>는 계좌정보를 저장하는 객체다.
	 * 	Key는 계좌번호(Integer)
	 *	Value는 계좌정보는(Account)
	 */
	 ...
	 * 반환타입 : List<Account>		-> 콜렉션
	 * 메소드명 : getAccountsByNme
	 * 매개변수 : String name
	 */
	public List<Account> getAccountsByName (String name) {
//		List<Account> accounts = null;	-> List객체는 null이면 안된다. 비어있어야 함
		List<Account> accounts = new ArrayList<>();
		
		Collection<Account> values = map.values();	// -> map의 value들만 얻어지는 메소드
	...
	// 변경기능
	/*
	 * 변경된 정보가 반영된 계좌정보를 전달 받아서 Map객체에 적용시킨다.
	 * 반환타입 : void
	 * 메소드명 : updateAccount
	 * 매개변수 : Account account
	 */
